...
- (void)viewDidLoad {
  ...
  self.navigationItem.title = NSLocalizedStringFromTable(@"Private", @"RongCloudKit",nil);
    ...
    case 0: {
      switch (indexPath.row) {
        case 0: {
          ...
          cell.leftLabel.text = NSLocalizedStringFromTable(@"Black List", @"RongCloudKit",nil);
        }
          break;
