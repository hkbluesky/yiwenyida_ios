...
- (void)viewDidLoad {
  ...
  self.navigationItem.title = NSLocalizedStringFromTable(@"News Notification", @"RongCloudKit",nil);
    ...
    case 0: {
      switch (indexPath.row) {
        case 0: {
          ...
          cell.leftLabel.text = NSLocalizedStringFromTable(@"Accept Msg Notice", @"RongCloudKit",nil);
        ...
        case 1: {
          ...
          cell.leftLabel.text = NSLocalizedStringFromTable(@"No Disturbing Setting", @"RongCloudKit",nil);
