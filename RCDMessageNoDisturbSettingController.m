...
- (void)viewDidLoad {
  ...
  self.title = NSLocalizedStringFromTable(@"No Disturbing Setting", @"RongCloudKit",nil);;
  ...
  if (_swch.on) {
    ...
    [[RCIMClient sharedRCIMClient] setNotificationQuietHours:startTime
        ...
        error:^(RCErrorCode status) {
          dispatch_async(dispatch_get_main_queue(), ^{
            UIAlertView *alert =
                [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"Setting", @"RongCloudKit",nil)
                                           message:NSLocalizedStringFromTable(@"Setting Failure", @"RongCloudKit",nil)
                                          delegate:nil
  ...
  if (indexPath.section == 0) {
    switch (indexPath.row) {
      case 0: {
        ...
        cell.textLabel.text = NSLocalizedStringFromTable(@"Open No-Disturb Mode", @"RongCloudKit",nil);
      ...
      case 1: {
        cell.textLabel.text = NSLocalizedStringFromTable(@"Start Time", @"RongCloudKit",nil);
      } break;
      case 2: {
        cell.textLabel.text = NSLocalizedStringFromTable(@"End Time", @"RongCloudKit",nil);
      } break;
      default:
        break;
    }
  ...
  if (swich.on) {
    ...
    [[RCIMClient sharedRCIMClient] setNotificationQuietHours:startTimeStr
        ...
        error:^(RCErrorCode status) {
          dispatch_async(dispatch_get_main_queue(), ^{
            UIAlertView *alert =
                [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"Notice", @"RongCloudKit",nil)
                                           message:NSLocalizedStringFromTable(@"Setting Failure", @"RongCloudKit",nil)
                                          delegate:nil
                                 cancelButtonTitle:NSLocalizedStringFromTable(@"Cancel", @"RongCloudKit",nil)
                                 otherButtonTitles:nil, nil];
    ...
    [[RCIMClient sharedRCIMClient] removeNotificationQuietHours:^{
        ...
        error:^(RCErrorCode status) {
          dispatch_async(dispatch_get_main_queue(), ^{
            UIAlertView *alert =
                [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"Notice", @"RongCloudKit",nil)
                                           message:NSLocalizedStringFromTable(@"Close Failure", @"RongCloudKit",nil)
                                          delegate:nil
                                 cancelButtonTitle:NSLocalizedStringFromTable(@"Cancel", @"RongCloudKit",nil)
                                 otherButtonTitles:nil, nil];
            [alert show];
